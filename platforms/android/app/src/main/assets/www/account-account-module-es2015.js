...
/* harmony import */ var _public_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./public_api */ "./node_modules/@angular/fire/storage/es2015/public_api.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ref__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ref */ "./node_modules/@angular/fire/storage/es2015/ref.js");
...
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage */ "./node_modules/@angular/fire/storage/es2015/storage.js");
...
/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./task */ "./node_modules/@angular/fire/storage/es2015/task.js");
...
/* harmony import */ var _observable_fromTask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./observable/fromTask */ "./node_modules/@angular/fire/storage/es2015/observable/fromTask.js");
...
/* harmony import */ var _storage_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./storage.module */ "./node_modules/@angular/fire/storage/es2015/storage.module.js");
...
/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./task */ "./node_modules/@angular/fire/storage/es2015/task.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");


function createStorageRef(ref, schedulers, keepUnstableUntilFirst) {
    return {
        getDownloadURL: () => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(ref.getDownloadURL(), schedulers.outsideAngular).pipe(keepUnstableUntilFirst),
        getMetadata: () => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(ref.getMetadata()).pipe(keepUnstableUntilFirst),
        delete: () => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(ref.delete()),
        child: (path) => createStorageRef(ref.child(path), schedulers, keepUnstableUntilFirst),
        updateMetatdata: (meta) => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(ref.updateMetadata(meta)),
        updateMetadata: (meta) => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(ref.updateMetadata(meta)),
        put: (data, metadata) => {
...
/* harmony import */ var _ref__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ref */ "./node_modules/@angular/fire/storage/es2015/ref.js");
...
const StorageBucket = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('angularfire2.storageBucket');
...
let AngularFireStorage = class AngularFireStorage {
    constructor(options, nameOrConfig, storageBucket, platformId, zone) {
        ...
        this.storage = zone.runOutsideAngular(() => {
            const app = Object(_angular_fire__WEBPACK_IMPORTED_MODULE_2__["_firebaseAppFactory"])(options, zone, nameOrConfig);
    ...
    upload(path, data, metadata) {
        ...
        const ref = Object(_ref__WEBPACK_IMPORTED_MODULE_1__["createStorageRef"])(storageRef, this.schedulers, this.keepUnstableUntilFirst);
...
/* harmony import */ var _observable_fromTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./observable/fromTask */ "./node_modules/@angular/fire/storage/es2015/observable/fromTask.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");


function createUploadTask(task) {
    const inner$ = Object(_observable_fromTask__WEBPACK_IMPORTED_MODULE_0__["fromTask"])(task);
    return {
        task: task,
        ...
        percentageChanges: () => inner$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(s => s.bytesTransferred / s.totalBytes * 100))
    };
}
...
/* harmony import */ var _core_service_image_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../core/service/image.service */ "./src/app/core/service/image.service.ts");
...
/* harmony import */ var _shared_component_profile_pic_modal_pic_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./../../shared/component/profile/pic-modal/pic-modal.component */ "./src/app/shared/component/profile/pic-modal/pic-modal.component.ts");
...
let AccountPage = class AccountPage {
    constructor(changeDetectorRefs, alertCtrl, authService, afStorage, imageService, alertController, router, userService, modalController) {
        ...
        this.imagesTrackFn = (i, image) => image.photoName;
            ...
            uploadImagesRef.put(this.selectedFile).then(snapshot => {
                ...
                this.imageRef.get().subscribe(imageData => {
                    ...
                    if (!imageData.exists) {
                        ...
                        const storage = firebase__WEBPACK_IMPORTED_MODULE_5__["storage"]();
    ...
    loadPhotos() {
        ...
        this.imageService
            ...
            for (const image of this.images) {
                ...
                pathReference.getDownloadURL().then(url => {
                    if (this.imageUrls.find(image => image === url)) { }
                    else {
...
AccountPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"],
        ...
        _core_service_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"],
