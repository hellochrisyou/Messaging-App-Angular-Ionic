...
/* harmony import */ var _core_service_auth_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/service/auth.service */ "./src/app/core/service/auth.service.ts");
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_core_service_auth_service__WEBPACK_IMPORTED_MODULE_9__["AuthService"],
...
let AuthService = class AuthService {
    constructor(router, ngZone, afAuth, 
    ...
    signinGoogle() {
        console.log('hello');
        this.afAuth.auth.signInWithPopup(new firebase__WEBPACK_IMPORTED_MODULE_7__["auth"].GoogleAuthProvider()).then((credential) => {
    ...
    updateUserData(user) {
        ...
        const userRef = this.afs.doc(`users/${user.email}`);
        const data = {
            uId: user.uId,
            email: user.email,
    ...
    checkUserExists(argEmail, argDisplayName, argPhotoUrl) {
...
module.exports = __webpack_require__(/*! C:\github\messaging-app\src\main.ts */"./src/main.ts");
